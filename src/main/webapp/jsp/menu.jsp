...
.back-to-category-btton:hover {
    background-color: #111827; /* Darker navy on hover */
    transform: translateY(-3px); /* Slight lift on hover */
}

.back-to-category-btton.icon-only {
...
.back-to-category-btton.icon-only i {
...
<!-- Back Button -->
<button id="back-to-category-btn" class="back-to-category-btton" onclick="goBackToCategory()">
...
<script>
    ...
    function showItemsFrame(categoryUrl) {
        ...
        const backToCategoryBtn = document.getElementById('back-to-category-btton');
 ...
 // Function to show the items iframe and hide the category iframe when a category is clicked
    function showItemsFrame(categoryUrl) {
        const categoryFrame = document.getElementById('category-frame');
        const itemsFrame = document.getElementById('items-frame');
        const backToCategoryBtn = document.getElementById('back-to-category-btn'); // Correct ID reference
